      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'mainHomePage')
        ...
        FFRoute(
          ...
          path: '/mainFavorites',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'mainFavorites')
              : const MainFavoritesWidget(),
        ),
        FFRoute(
          name: 'sellerDetails',
          path: '/sellerDetails',
          builder: (context, params) => const SellerDetailsWidget(),
        ),
        FFRoute(
          name: 'loginPage',
          path: '/loginPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'mainOrderHistory')
              : const MainOrderHistoryWidget(),
        ),
        FFRoute(
          name: 'mainProfile',
          path: '/mainProfile',
        ...
        FFRoute(
          ...
          path: '/successPage',
          asyncParams: {
            'ordersRef': getDoc(['orders'], OrdersRecord.fromSnapshot),
          },
          builder: (context, params) => SuccessPageWidget(
            orderTotal: params.getParam('orderTotal', ParamType.double),
            ordersRef: params.getParam('ordersRef', ParamType.Document),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'checkoutCopy',
          path: '/checkoutCopy',
          builder: (context, params) => const CheckoutCopyWidget(),
        ),
        FFRoute(
          name: 'create_Item',
          path: '/createItem',
