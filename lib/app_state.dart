...
class FFAppState extends ChangeNotifier {
  ...
  List<ShippingOptionsStruct> _shippingOptions = [
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{"shippingName":"Rikaab","description":"Get your shipment in 2-5 business hours","price":"2"}')),
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{"shippingName":"Mooto Bajaaj","description":"Get your shipment in 2-3 business hours","price":"3"}'))
  ];
